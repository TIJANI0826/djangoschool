...
class User(AbstractUser):
    ...
    is_lecturer = models.NullBooleanField(default=False)
...
class Session(models.Model):
    ...
    is_current_session = models.NullBooleanField(default=False, blank=True, null=True)
...
class Semester(models.Model):
    ...
    is_current_semester = models.NullBooleanField(default=False, blank=True, null=True)
...
class Course(models.Model):
    ...
    is_elective = models.NullBooleanField(default=False, blank=True, null=True)
